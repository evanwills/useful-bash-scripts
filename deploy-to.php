...
$regex = '/^deployList__[0-9]{4}-[0-9]{2}-[0-9]{2}--[0-9]{2}-[0-9]{2}-[0-9]{2}\.sh$/i';
...
/**
 * Make sure "file" is gramatically correct for the number of
...
/**
 * Make sure "group" is gramatically correct for the number of
 * destination paths
 *
 * @var string
 */
...
/**
 * Human readable representation of the time files were deployed
 * to the selected environment
 *
 * @var string
 */
$since = date('H:i:s D, \t\h\e jS \o\f M Y', $sinceTime);
...
echo \'that have been updated since\';
echo \'     '.$since.';
echo;
[[OUTPUT]]
echo;
